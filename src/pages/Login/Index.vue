    ...
    <div class="content">
      <div class="row">
        <div class="login">
          ...
          <!--div class="title mb-3">{{header.title.title1}} {{header.title.title2}}</div-->
          ...
          <form data-toggle="validator" role="form" id="loginFrm">
            ...
            <div class="form-group">
              ...
              <input type="password" class="form-control" id="password" placeholder="Password" v-model="user.password" v-on:keyup="keymonitor" data-error="this field is required" required>
              <div class="help-block with-errors"></div>
            </div>
            ...
            <div class="button-area">
              <button type="button" class="btn btn-success col" @click="login" v-if="!loading">Sign in</button>
              <div v-if="loading">
                <i class="fa fa-spinner fa-spin" style="font-size:24px"></i>
              </div>
            </div>
            <div class="link" @click="forgotPassword"><a>Forgot Password?</a></div>
          </form>
        </div>
      </div>
